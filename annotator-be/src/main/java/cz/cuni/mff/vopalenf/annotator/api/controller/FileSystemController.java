...
public class FileSystemController {
    ...
    @Operation(summary = "Get a specific frame from a project", description = "Retrieves a single frame from the specified project at the given position.", parameters = {
            @Parameter(in = ParameterIn.PATH, name = "projectId", schema = @Schema(type = "integer"), description = "ID of the project"),
            @Parameter(in = ParameterIn.PATH, name = "position", schema = @Schema(type = "integer"), description = "Position of the frame within the project")}, responses = {
    ...
    @GetMapping(value = "/projects/{projectId}/frame/{position}", produces = MediaType.IMAGE_JPEG_VALUE)
    ...
    @Operation(summary = "Get the total number of frames in a project", description = "Retrieves the count of available frames in the specified project.", parameters = {
            @Parameter(in = ParameterIn.PATH, name = "id", schema = @Schema(type = "integer"), description = "ID of the project")}, responses = {
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_ADMIN', 'ROLE_USER')")
    @GetMapping(value = "/projects/{id}/frame/count", produces = MediaType.APPLICATION_JSON_VALUE)

...
/**
 * Exception to be thrown when the content type is understood by server but is
 * unable to process inner instructions
 */
public class UnprocessableContentException extends APIException {
    /**
     * Constructs a new UnprocessableContentException with the specified message and
     * scope.
     *
     * @param message
     *            the detail message

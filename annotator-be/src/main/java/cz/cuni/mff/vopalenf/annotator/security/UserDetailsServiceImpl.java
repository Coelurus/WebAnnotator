...
/**
 * Implementation of UserDetailsService to load user-specific data. This service
 * is used by Spring Security to retrieve user details for authentication and
 * authorization.
 */
@Service
public class UserDetailsServiceImpl implements UserDetailsService {
     ...
     *            the UserRepository instance to use for fetching UserEntity by
     *            username
     */
